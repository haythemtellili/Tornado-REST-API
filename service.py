...
logging.basicConfig(level=logging.INFO, filename="model_service.log", filemode='a',
...
define("detection_model", default="Mask_rcnn_model_v2.pt", help="model to segment objects")
define("iou_threshold", default=0.2, help="IOU threshold")
define("mask_thresh", default=0.2, help="Mask threshold")
define("classification_confidence_threshold", default=0.7, help="classification confidence threshold")
def make_app(args):
    """
...
class PredictHandler(RequestHandler):
    ...
    async def async_load_image_from_url(url, http_client=http_client):
        ...
        try:
            ...
            logger.info(f"Get image by URL request time: {requested_image.request_time} second(s).")
